/**
 * Phase 11F-B — load STUDY-BETA-001 thin operational runtime (data only).
 *
 * Usage:
 *   node scripts/load-validation-protocol-002-runtime.mjs
 *   node scripts/load-validation-protocol-002-runtime.mjs --dry-run
 */
...
const manifest = JSON.parse(
  readFileSync(join(projectRoot, 'fixtures/validation-protocol-002/runtime-manifest.v1.json'), 'utf8'),
)
