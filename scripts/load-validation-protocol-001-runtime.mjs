/**
 * Phase 11F-A — load STUDY-ALPHA-001 thin operational runtime (data only).
 *
 * Usage:
 *   node scripts/load-validation-protocol-001-runtime.mjs
 *   node scripts/load-validation-protocol-001-runtime.mjs --dry-run
 */
...
const manifest = JSON.parse(
  readFileSync(join(projectRoot, 'fixtures/validation-protocol-001/runtime-manifest.v1.json'), 'utf8'),
)
...
async function main() {
  ...
  try {
    ...
    step('visit definitions', true, `${visitIdByCode.size} visits`)
