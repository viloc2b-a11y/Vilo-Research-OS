...
def main():
    ...
    task_name = "pi_subject_document_review_audit"
    ...
    output_path = "validation-corpus/metadata/pi-subject-document-review-audit.md"
    
    md_content = """# PI Subject Document Review Audit
    ...
    manifest = {
        ...
        "acceptance_report": {
            ...
            "checks": [
                {
                    "id": "AUDIT_COMPLETED",
                    "description": "PI Subject Document Review runtime audited",
                    "critical": True,
                    "pass": True,
