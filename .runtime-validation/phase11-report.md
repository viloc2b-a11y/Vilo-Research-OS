...
- [PASS] **Financial leakage derives correctly** — 8 leakage item(s), score 75.
...
- [PASS] **Runtime actions emit operational_events (live visit)** — 38 operational_event(s) for visit.
...
- [PASS] **Automation proposal can be applied (supervised)** — 6 proposed; pending=6; applied=0
