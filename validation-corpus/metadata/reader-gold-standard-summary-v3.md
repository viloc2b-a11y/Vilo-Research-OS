...
- **GOLD_V3_017 (004_Viro_HSV_IgG_LFA_Clinical Protocol_Final.pdf_V1.1 (1).pdf)** - PROTOCOL / MEDIUM (1.58 MB)
  *Reason:* Core Protocol Analysis
- **GOLD_V3_019 (mRNA-1647-P301-protocol_amendment_7-final.pdf)** - AMENDMENT / MEDIUM (1.47 MB)
  *Reason:* Core Protocol Analysis
- **GOLD_V3_021 (RFP_DUB-001 version 0.2x_Clinical Study Protocol Synopsis Phase I and 2a_CLEAN (2).pdf)** - PROTOCOL / MEDIUM (1.27 MB)
  *Reason:* Core Protocol Analysis
- **GOLD_V3_022 (M14-533 protocol amendment 8.pdf)** - AMENDMENT / MEDIUM (1.06 MB)
  *Reason:* Core Protocol Analysis
- **GOLD_V3_023 (Ingenuity Dual protocol 09Sep25 vus1.0final-signed.pdf)** - PROTOCOL / MEDIUM (1.00 MB)
  *Reason:* Core Protocol Analysis
- **GOLD_V3_024 (GS-US-553-9020 Protocol 20200828.pdf)** - PROTOCOL / MEDIUM (0.98 MB)
  *Reason:* Core Protocol Analysis

### Duplication Statistics
- Total duplicates avoided: 6
- See `reader-gold-standard-duplicates.md` for full breakdown.
