...
| **PARA_OA_012** | Osteoarthritis | NO | NO | NO | NO | NO | NO | NO | **Never Mined (Smoke Test Only)** |
| **MV40618** | Unknown | NO | NO | NO | NO | NO | NO | NO | **Never Mined (Smoke Test Only)** |
...
- **PARA_OA_012 (Osteoarthritis):** *Value:* **HIGH**. Contains unblinded pharmacy manuals, IP temperature excursion rules, and eCOA manual rules.
- **VBVIR78315008:** *Value:* **MEDIUM**. Antiviral completion guidelines.
- **MV40618:** *Value:* **MEDIUM**. Complex eCRF completion guidelines.
...
2. **PARA_OA_012** — *Will teach VIP unblinded pharmacy workflows, IP storage excursion logic, and eCOA device management.*
...
6. **MV40618** — *Will teach VIP complex eCRF logic and data-entry boundary abstractions.*
