...
|------|-----------------------------|---------------------------|------------------------------|
| **1** | **Unblinded Pharmacy & Temp Excursions** | `PARA_OA_012` (Pharmacy Manual) | **CRITICAL DEVIATION PREVENTION.** Temp excursions cause massive IP wastage. VIP needs rules for Quarantine -> Sponsor Approval -> Dispense. |
...
| **6** | **eCRF Transcription Boundaries** | `MV40618` (eCRF Guidelines) | **EFFICIENCY VALUE.** Learning how data moves from Source to EDC. |
