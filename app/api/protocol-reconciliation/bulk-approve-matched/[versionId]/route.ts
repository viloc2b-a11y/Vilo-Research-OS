...
export async function POST(req: NextRequest, context: RouteContext) {
  ...
  const { data: matched, error: fetchError } = await supabase
    ...
    .eq('reconciliation_status', PROCEDURE_RECONCILIATION_STATUS.MATCHED)
