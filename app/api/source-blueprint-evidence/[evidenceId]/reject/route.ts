...
import { rejectSourceBlueprintEvidence } from '@/lib/source-blueprint-evidence/reject-source-blueprint-evidence'
...
export async function POST(req: NextRequest, context: RouteContext) {
  ...
  try {
    const evidence = await rejectSourceBlueprintEvidence({
      supabase,
