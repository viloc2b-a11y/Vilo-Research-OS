...
drop policy if exists document_intelligence_documents_select on public.document_intelligence_documents;
...
drop policy if exists document_intelligence_chunks_select on public.document_intelligence_chunks;
...
drop policy if exists document_intelligence_ingestion_runs_select on public.document_intelligence_ingestion_runs;
...
drop policy if exists document_intelligence_search_events_select on public.document_intelligence_search_events;
