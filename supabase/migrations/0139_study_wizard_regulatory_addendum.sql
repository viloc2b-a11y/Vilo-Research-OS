...
ALTER TABLE public.study_delegation_log
  ...
  ADD COLUMN initials_verification boolean NOT NULL DEFAULT false,
  ADD COLUMN delegation_date date,
  ADD COLUMN qualification_verified_by uuid REFERENCES auth.users(id),
  ADD COLUMN qualification_verification_date date;
...
ALTER TABLE public.study_protocol_trainings
  ADD COLUMN refresher_required boolean NOT NULL DEFAULT false,
  ADD COLUMN refresher_date date,
  ADD COLUMN certificate_attached boolean NOT NULL DEFAULT false;
