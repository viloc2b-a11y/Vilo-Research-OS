...
CREATE TABLE study_runtime_visits (
...
CREATE INDEX idx_study_runtime_visits_org ON study_runtime_visits(organization_id);
CREATE INDEX idx_study_runtime_visits_study ON study_runtime_visits(study_id);
CREATE INDEX idx_study_runtime_visits_code ON study_runtime_visits(visit_code);
CREATE INDEX idx_study_runtime_visits_type ON study_runtime_visits(visit_type);
CREATE INDEX idx_study_runtime_visits_sequence ON study_runtime_visits(sequence_order);
CREATE INDEX idx_study_runtime_visits_status ON study_runtime_visits(status);

CREATE TABLE study_runtime_visit_procedures (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  organization_id uuid NOT NULL,
  study_id uuid NOT NULL REFERENCES studies(id) ON DELETE CASCADE,
...
CREATE INDEX idx_study_runtime_visit_procedures_org ON study_runtime_visit_procedures(organization_id);
CREATE INDEX idx_study_runtime_visit_procedures_study ON study_runtime_visit_procedures(study_id);
CREATE INDEX idx_study_runtime_visit_procedures_visit ON study_runtime_visit_procedures(visit_id);
CREATE INDEX idx_study_runtime_visit_procedures_procedure ON study_runtime_visit_procedures(procedure_id);
CREATE INDEX idx_study_runtime_visit_procedures_version ON study_runtime_visit_procedures(blueprint_version_id);
CREATE INDEX idx_study_runtime_visit_procedures_order ON study_runtime_visit_procedures(procedure_order);

CREATE TABLE study_runtime_composition_snapshots (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  organization_id uuid NOT NULL,
  study_id uuid NOT NULL REFERENCES studies(id) ON DELETE CASCADE,
...
CREATE INDEX idx_study_runtime_snapshots_org ON study_runtime_composition_snapshots(organization_id);
CREATE INDEX idx_study_runtime_snapshots_study ON study_runtime_composition_snapshots(study_id);
CREATE INDEX idx_study_runtime_snapshots_status ON study_runtime_composition_snapshots(snapshot_status);
CREATE INDEX idx_study_runtime_snapshots_hash ON study_runtime_composition_snapshots(graph_hash);
